...
class SubarraysWithProductLessThanATarget{
    public static List<List<Integer>> getContiguousSubArrays(int[] arr, int target) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (num < target) {
                ...
                contiguousList.add(num);
                result.add(new ArrayList<>(contiguousList));
    ...
    public static void main(String[] args) {
        System.out.println(getContiguousSubArrays(new int[]{2, 5, 3, 10}, 30));
        System.out.println(getContiguousSubArrays(new int[]{8, 2, 6, 5}, 50));
        System.out.println("--------------");
